...
class _CategoryCardState extends State<_CategoryCard>
  ...
  IconData _icon(String title) {
    switch (title) {
      ...
      case '发型': return Icons.auto_fix_high_outlined;
      case '配饰': return Icons.diamond_outlined;
  ...
  Color _iconBg(String title) {
    switch (title) {
      ...
      case '发型': return const Color(0xFFFCE4EC);
      case '配饰': return const Color(0xFFFFF8E1);
              ...
              child: Row(
                children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          ...
                          size: 20,
                          color: widget.selected ? AppColors.primary : AppColors.neutral400,
                        ),
                      ),
                    ),
                  Container(
                  ...
                  Expanded(
                    child: Text(
                      widget.title,
                      style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: AppColors.warmBrown),
                    ),
                  ),
                  Container(
                    width: 28, height: 28,
                    ...
                    child: AnimatedRotation(
                      ...
                      duration: const Duration(milliseconds: 250),
                      child: const Icon(Icons.keyboard_arrow_down, size: 16, color: AppColors.neutral500),
                    ),
                  ),
                ],
              ),
            ...
            SizeTransition(
              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  style: const TextStyle(fontSize: 13, height: 1.6, color: AppColors.neutral500),
                ),
              ),
            ),
          ],
